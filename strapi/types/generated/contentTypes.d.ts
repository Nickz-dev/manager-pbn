...
export interface ApiContentArticleContentArticle
  extends Struct.CollectionTypeSchema {
  collectionName: 'content_articles';
  info: {
    displayName: 'Content Article';
    pluralName: 'content-articles';
...
export interface ApiContentAuthorContentAuthor
  extends Struct.CollectionTypeSchema {
  collectionName: 'content_authors';
  info: {
    displayName: 'Content Author';
    pluralName: 'content-authors';
    singularName: 'content-author';
  };
  options: {
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    experience_years: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    pbn_sites: Schema.Attribute.Relation<
      'manyToMany',
      'api::pbn-site.pbn-site'
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.String &
      Schema.Attribute.Required &
    ...
    specialization: Schema.Attribute.Enumeration<
      ['casino', 'sports', 'crypto', 'finance', 'general']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiContentCategoryContentCategory
  ...
  attributes: {
    ...
    content_categories: Schema.Attribute.Relation<
      ...
      'api::content-category.content-category'
    >;
    content_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::content-category.content-category'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiPbnSitePbnSite extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'PBN Site';
    pluralName: 'pbn-sites';
    singularName: 'pbn-site';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    statuspbn: Schema.Attribute.Enumeration<
